    ...
    return (
        <div className="min-h-screen bg-[#e8f1fb] font-sans text-gray-900 relative overflow-hidden flex flex-col">
            ...
            <div className="absolute inset-0 z-10 flex items-center justify-center p-4 backdrop-blur-[2px]">
                <div className="bg-white rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] w-full max-w-[900px] flex flex-col md:flex-row overflow-hidden border border-white/50 max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center bg-white">
                        <h3 className="text-[22px] font-bold text-black mb-8">Sign Up</h3>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-[14px] border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-black focus:border-transparent outline-none transition text-[13px] shadow-sm text-black"
                                    value={data.name}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-4 py-3 rounded-[14px] border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-black focus:border-transparent outline-none transition text-[13px] shadow-sm text-black pr-10"
                                        value={data.password}
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full mt-4 flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white font-semibold py-3.5 rounded-[14px] transition shadow-md hover:shadow-lg disabled:opacity-50 text-[13px]"
                            >
                        ...
                        <div className="mt-8 flex items-center justify-start text-[11px]">
                            ...
                            <Link href={route('login')} className="ml-1.5 font-bold text-gray-900 hover:underline">
                                Log in
                            </Link>
                        </div>
                    </div>
